...
The thinker is a full agent loop in the ReAct style~\cite{yao2022react}: the
...
complexity~\cite{ousterhout2018philosophy}. A well-designed skill exposes a
...
network~\cite{hinton2015distilling}. A.L.F.R.E.D.\ distills along the same
