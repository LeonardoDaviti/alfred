...
directly. \citet{belcak2025slm} contend that small language models,
...
\citet{dekoninck2024unifiedrouting} give a unified treatment of
...
uses with patterns. Its successor, Memento-Skills~\citep{zhou2026mementoskills},
...
approaches such as OpenClaw-RL~\citep{wang2026openclawrl}; this is the path
...
to Reflexion~\citep{shinn2023reflexion}, which uses verbal self-feedback as a form
...
behaviour into a deployable model~\citep{hinton2015distilling}. A.L.F.R.E.D.\
...
such as DSPy~\citep{khattab2024dspy}, which compiles declarative model calls into
...
multi-step goals---AgentBench~\citep{liu2023agentbench} across diverse
environments, and AssistantBench~\citep{yoran2024assistantbench} for realistic,
...
agents with packaged capabilities~\citep{anthropic2025skills}, with which
