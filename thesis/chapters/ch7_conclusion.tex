...
device---observing actual codes before committing an encoding---would convert those
guesses into facts and close the remaining convention errors. The integrity rule
carries over: ground on the device or a development split, never on the evaluation
gold.
...
is sibling discrimination---better selection prompting or a learned selector over
behavioural signals---since the router gates both tiers.
